...
public class LoginPageController {
    ...
    private void validFields() {
        ...
        hyperSignIn.setDisable(!(isValidUsername && isValidPassword));
    }
    ...
    public void btnSignInOnAction(ActionEvent actionEvent) {
        ...
        try {
            ResultSet resultSet = SQLUtil.executeQuery("SELECT * FROM admin WHERE name = ? AND password = ?",
    ...
    public void hyperSignUpOnAction(ActionEvent actionEvent) {
        try {
